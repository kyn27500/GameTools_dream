...
# 资源目录
sourcePath = "/Users/koba/Documents/svn_fish/meishu/动画的/鱼/"
# 目标目录
targetPath = "/Users/koba/Documents/work/FishingGame_Client/modules/fishing/res/fish/"
# 忽略文件夹
ignoreDir = []
# 忽略文件
ignoreFile = []
...
# 通用参数
params = "--format cocos2d --texture-format png  --size-constraints AnySize  --opt RGBA4444 --trim --smart-update --enable-rotation"
# 打包指令
